...
import os
import sys
sys.path.append('/Users/ms/code/sense/HiwonderSDK/')
import time
...
def setBusServoPulse(id, pulse, use_time):
    ...
    use_time = 0 if use_time < 0 else use_time
    #print('in set bus servo pulse 1')
    use_time = 30000 if use_time > 30000 else use_time
    #print('in set bus servo pulse 2')
    #print(LOBOT_SERVO_MOVE_TIME_WRITE)
    #print(id)
    #print(pulse)
    #print(use_time)
    serial_serro_wirte_cmd(id, LOBOT_SERVO_MOVE_TIME_WRITE, pulse, use_time)
    #print('in set bus servo pulse 3')
